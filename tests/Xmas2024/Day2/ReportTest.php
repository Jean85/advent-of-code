...
class ReportTest extends TestCase
{
    ...
    #[DataProvider('isSafeWithDampenerDataProvider')]
    public function testIsSafeWithDampener(string $input, bool $expected): void
    {
        $report = new Report($input);

        $this->assertSame($expected, $report->isSafeWithDampener());
    }

    public static function isSafeWithDampenerDataProvider(): array
    {
        return [
            ['7 6 4 2 1', true],
            ['1 2 7 8 9', false],
